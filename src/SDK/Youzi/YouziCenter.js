...
export default class YouziCenter {
     ...
     */
    createMoreGameUI(parentNode, params, uiStateCall) {
     ...
     * @param uiStateCall ui显示和隐藏回调
     */
    createMoreGameUIH(parentNode, params, uiStateCall) {
    ...
    createSlideButton(parentNode, params, leftOrRight, isAutoClick) {
        ...
        let dot = new Laya.Image('spear_io_start/ui_public_red.png');
        dot.pos(-13, -13);
     ...
     * @param uiStateCall ui显示和隐藏回调
     */
    createSlideWindowUI(parentNode, params, leftOrRight, uiStateCall) {
     ...
     * @param uiStateCall ui显示和隐藏回调
     */
    createSlideWindowUIH(parentNode, params, leftOrRight, uiStateCall) {
     ...
     */
    createBottomBanner(parentNode, params, isOffSwich) {
     ...
     * @param uiStateCall ui显示和隐藏回调
     */
    createOffline(parentNode, params, uiStateCall) {
     ...
     * @param uiStateCall ui显示和隐藏回调
     */
    createOfflineH(parentNode, params, uiStateCall) {
